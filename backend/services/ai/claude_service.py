...
Be specific about the complexity and explain your reasoning."""
            ...
            user_message = f"""Analyze the time and space complexity of the following {language} code. First, infer what problem this code is solving based on the method names, data structures, and logic patterns, then provide the complexity analysis.
...
Make hints increasingly specific but never give away the full solution."""
            ...
            user_message = f"""The user has written some code but needs guidance. First infer what problem they're trying to solve from the code, then provide progressive hints.
...
Focus on practical improvements with significant impact."""
            ...
            user_message = f"""Analyze this {language} solution and suggest optimizations. First infer what problem this code is solving, then provide optimization suggestions.
...
Be specific about line numbers and provide concrete fixes."""
            ...
            user_message = f"""Debug this {language} code for potential issues. First infer what problem this code is trying to solve, then identify bugs.
...
A complete solution should have proper function definition, logic implementation, and return statement."""
    ...
    async def infer_problem_from_code(
        ...
        user_message = f"""Analyze this {language} code and infer which LeetCode problem it's trying to solve:
